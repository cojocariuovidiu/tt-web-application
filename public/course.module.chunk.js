...
var CourselistComponent = /** @class */ (function () {
    ...
    CourselistComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.titleService.setTitle(this.title);
        this.courses.push(new __WEBPACK_IMPORTED_MODULE_1__model_course_model__["a" /* Course */]('1', 'Java', 'Python is an interpreted high-level programming language for general-purpose programming. Created by Guido van Rossum and first released in 1991, Python has a design philosophy that emphasizes code readability, notably using significant whitespace. It provides constructs that enable clear programming on both small and large scales.', null, null));
        this.courses.push(new __WEBPACK_IMPORTED_MODULE_1__model_course_model__["a" /* Course */]('1', 'C sharp', 'Python is an interpreted high-level programming language for general-purpose programming. Created by Guido van Rossum and first released in 1991, Python has a design philosophy that emphasizes code readability, notably using significant whitespace. It provides constructs that enable clear programming on both small and large scales.', null, null));
        this.courses.push(new __WEBPACK_IMPORTED_MODULE_1__model_course_model__["a" /* Course */]('1', 'Script', 'Python is an interpreted high-level programming language for general-purpose programming. Created by Guido van Rossum and first released in 1991, Python has a design philosophy that emphasizes code readability, notably using significant whitespace. It provides constructs that enable clear programming on both small and large scales.', null, null));
        this.courses.push(new __WEBPACK_IMPORTED_MODULE_1__model_course_model__["a" /* Course */]('1', 'Python', 'Python is an interpreted high-level programming language for general-purpose programming. Created by Guido van Rossum and first released in 1991, Python has a design philosophy that emphasizes code readability, notably using significant whitespace. It provides constructs that enable clear programming on both small and large scales.', null, null));
        var cols_map = new Map([
            ['xs', 1],
            ['sm', 1],
            ['md', 2],
